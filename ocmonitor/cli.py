...
def _generate_export_report(report_type: str, path: Optional[str], report_generator, recalculate: bool = False) -> Optional[dict]:
    ...
    Args:
        ...
        recalculate: If True, ignore stored costs and recalculate from pricing data
    ...
    # Add recalculate parameter with the correct name for this report type
    recalculate_param = report_config.get("recalculate_param", "recalculate")
    params[recalculate_param] = recalculate
